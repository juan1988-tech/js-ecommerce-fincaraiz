 const Data = [
  { 
    ...
    PropertyPrice: 800000000,
    PropertyMonthlyRent: 6400000,
    PropertyLongDescription: `Esta es una casa muy bonita que está muy bien ubicada, y lo está por la sencilla razón de que queda en un barrio muy bonito de la ciudad.

    Además tiene muy buenos acabados y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Carrera 93U 131 - 26',
  },
  {
    ...
    PropertyLongDescription: `Esta es una casa fue arreglada por el mismísimo Lord Farquad, está muy bien ubicada y valorada, con excelente acabados y muy bonita.

    Además tiene muy buena ubicación y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Carrera 105P 31 12',
  },
  {
    ...
    PropertyPrice: 1300000000,
    PropertyMonthlyRent: 10400000,
    PropertyLongDescription: `Esta es una casa fue propiedad de Jairo Alonso, está muy bien ubicada en el barrio las cruces, con excelente acabados y muy bonita.

    Además tiene muy buena ubicación y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Calle 20 36 45',
  },
  {
    ...
    PropertyLongDescription: `Esta es una casa fue arreglada por el mismísimo Shrek, está muy bien ubicada en el Gloria Lara, con excelente acabados y muy bonita.

    Además tiene muy buena ubicación y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Diagonal 123 12 - 88',
  },
  {
    ...
    PropertyBathroomsPText: "3 baños",
    PropertyPrice: 500000000,
    PropertyLongDescription: `Esta es una casa fue arreglada por Joseph Joestar, Después de su viaje por Egipto para vencer a Dio, la maldad pura.
  ...
  },
  {
    ...
    PropertyMonthlyRent: 1000000,
    PropertyLongDescription: `Esta es una casa Bointa y bien educada, fue diseñada por la experta Arquitecta y lider en el sector Jocelyn Kujo, quien sabe mucho.

    Además tiene muy buena ubicación y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Calle 128 11 - 22',
  },
  {
    ...
    PropertyMonthlyRent: 3200000,
    PropertyLongDescription: `Esta es una casa diseñada con los más exquisitos detalles, fue creada por el grandísimo Jonhatan Joestar, y está muy bien ubicada.
  ...
  },
  {
    ...
    PropertyLongDescription: `Esta es una casa económica a comparación de las otras casas en el mercado, además tengamos en cuenta que es extremadamente comercial.

    Además tiene muy buena ubicación y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Calle 80 23a - 26',
  },
  {
    ...
    PropertyMeasurePText: "400 m2",
    PropertyBathroomsPText: "3 baños",
    PropertyPrice: 1150000000,
    PropertyMonthlyRent: 9200000,
    PropertyLongDescription: `Esta casita tiene inspraciones egipcias, y fue creada por el toque arquitectonico del gran navegador inglés, Dio Brando.

    Además tiene muy buena ubicación y toda la cosa, y espero que vean esta casa para que vean el trabajo del desarrollador web, que merece ser contratado`,
    PropertyAdress: 'Carrera 91 33 - 13',
  }
];
